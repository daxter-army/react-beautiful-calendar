...
const YearsX = (props) => {
    ...
    return (
        <div className={styles.yearsX__wrapper}>
            <button className={styles.shuffle__buttons} onClick={props.onLeftClick}><img className={styles.shuffle__button__img} src={ChevronLeft} alt="shuffle-btn-img"/></button>
            ...
            <button className={styles.shuffle__buttons} onClick={props.onRightClick}><img className={styles.shuffle__button__img} src={ChevronRight} alt="shuffle-btn-img"/></button>
        </div>
    )
}
