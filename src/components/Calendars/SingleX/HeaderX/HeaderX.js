...
const HeaderX = (props) => {
    ...
    return (
        <div className={styles.headerX__wrapper}>
            <button className={styles.HeaderX__shuffle__btn} onClick={props.onLeftClick}><img className={styles.shuffle__btn__img} src={ChevronLeft} alt="shuffle-btn-img" /></button>
            ...
            <button className={styles.HeaderX__shuffle__btn} onClick={props.onRightClick}><img className={styles.shuffle__btn__img} src={ChevronRight} alt="shuffle-btn-img" /></button>
        </div>
    )
}
